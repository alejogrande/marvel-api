...
import 'package:marvel_api/ui/pages/characters/character_detail.dart';
import 'package:marvel_api/ui/pages/characters/characters_page.dart';
import 'package:marvel_api/ui/pages/comics/comic_detail.dart';
...
final Map<String, Widget Function(BuildContext)> appRoutes = {
  ...
  Routes.characterDetail: (context) =>   const CharacterDetailPage(),
  Routes.comicDetail: (context) => const   ComicDetailPage(),
